...
//go:generate minimock -i github.com/Ghaarp/chat-server/internal/service.ChatService -o chat_service_minimock.go -n ChatServiceMock -p mocks
...
type ChatServiceMock struct {
	...
	StopServiceMock          mChatServiceMockStopService
}
...
func NewChatServiceMock(t minimock.Tester) *ChatServiceMock {
	...
	m.StopServiceMock = mChatServiceMockStopService{mock: m}
	m.StopServiceMock.callArgs = []*ChatServiceMockStopServiceParams{}
...
func (mmCreate *mChatServiceMockCreate) Expect(ctx context.Context, data *model.CreateRequest) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) ExpectDataParam2(data *model.CreateRequest) *mChatServiceMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *mChatServiceMockCreate) Inspect(f func(ctx context.Context, data *model.CreateRequest)) *mChatServiceMockCreate {
...
func (mmCreate *mChatServiceMockCreate) Set(f func(ctx context.Context, data *model.CreateRequest) (i1 int64, err error)) *ChatServiceMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mChatServiceMockCreate) When(ctx context.Context, data *model.CreateRequest) *ChatServiceMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("ChatServiceMock.Create mock is already set by Set")
	}
...
func (mmCreate *ChatServiceMock) Create(ctx context.Context, data *model.CreateRequest) (i1 int64, err error) {
	...
	if mmCreate.CreateMock.defaultExpectation != nil {
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmCreate.t.Errorf("ChatServiceMock.Create got unexpected parameter data, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
...
func (mmSendMessage *mChatServiceMockSendMessage) Expect(ctx context.Context, data *model.SendMessageRequest) *mChatServiceMockSendMessage {
	...
	mmSendMessage.defaultExpectation.params = &ChatServiceMockSendMessageParams{ctx, data}
...
// ExpectDataParam2 sets up expected param data for ChatService.SendMessage
func (mmSendMessage *mChatServiceMockSendMessage) ExpectDataParam2(data *model.SendMessageRequest) *mChatServiceMockSendMessage {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
...
func (mmSendMessage *mChatServiceMockSendMessage) Inspect(f func(ctx context.Context, data *model.SendMessageRequest)) *mChatServiceMockSendMessage {
...
func (mmSendMessage *mChatServiceMockSendMessage) Set(f func(ctx context.Context, data *model.SendMessageRequest) (err error)) *ChatServiceMock {
	if mmSendMessage.defaultExpectation != nil {
...
// Then helper
func (mmSendMessage *mChatServiceMockSendMessage) When(ctx context.Context, data *model.SendMessageRequest) *ChatServiceMockSendMessageExpectation {
	if mmSendMessage.mock.funcSendMessage != nil {
		mmSendMessage.mock.t.Fatalf("ChatServiceMock.SendMessage mock is already set by Set")
	}
	...
	expectation := &ChatServiceMockSendMessageExpectation{
		...
		params:             &ChatServiceMockSendMessageParams{ctx, data},
...
func (mmSendMessage *ChatServiceMock) SendMessage(ctx context.Context, data *model.SendMessageRequest) (err error) {
	...
	mm_params := ChatServiceMockSendMessageParams{ctx, data}
	...
	if mmSendMessage.SendMessageMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockSendMessageParams{ctx, data}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.data != nil && !minimock.Equal(*mm_want_ptrs.data, mm_got.data) {
				mmSendMessage.t.Errorf("ChatServiceMock.SendMessage got unexpected parameter data, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmSendMessage.t.Fatalf("Unexpected call to ChatServiceMock.SendMessage. %v %v", ctx, data)
	return
}
...
type mChatServiceMockStopService struct {
	optional           bool
	mock               *ChatServiceMock
	defaultExpectation *ChatServiceMockStopServiceExpectation
	expectations       []*ChatServiceMockStopServiceExpectation

	callArgs []*ChatServiceMockStopServiceParams
	mutex    sync.RWMutex
...
// ChatServiceMockStopServiceExpectation specifies expectation struct of the ChatService.StopService
type ChatServiceMockStopServiceExpectation struct {
	mock               *ChatServiceMock
	params             *ChatServiceMockStopServiceParams
	paramPtrs          *ChatServiceMockStopServiceParamPtrs
	expectationOrigins ChatServiceMockStopServiceExpectationOrigins

	returnOrigin string
	Counter      uint64
}

// ChatServiceMockStopServiceParams contains parameters of the ChatService.StopService
type ChatServiceMockStopServiceParams struct {
	ctx context.Context
}

// ChatServiceMockStopServiceParamPtrs contains pointers to parameters of the ChatService.StopService
type ChatServiceMockStopServiceParamPtrs struct {
	ctx *context.Context
}

// ChatServiceMockStopServiceOrigins contains origins of expectations of the ChatService.StopService
type ChatServiceMockStopServiceExpectationOrigins struct {
	origin    string
	originCtx string
}
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmStopService *mChatServiceMockStopService) Optional() *mChatServiceMockStopService {
	mmStopService.optional = true
	return mmStopService
}

// Expect sets up expected params for ChatService.StopService
func (mmStopService *mChatServiceMockStopService) Expect(ctx context.Context) *mChatServiceMockStopService {
	if mmStopService.mock.funcStopService != nil {
		mmStopService.mock.t.Fatalf("ChatServiceMock.StopService mock is already set by Set")
	}

	if mmStopService.defaultExpectation == nil {
		mmStopService.defaultExpectation = &ChatServiceMockStopServiceExpectation{}
	}

	if mmStopService.defaultExpectation.paramPtrs != nil {
		mmStopService.mock.t.Fatalf("ChatServiceMock.StopService mock is already set by ExpectParams functions")
	}

	mmStopService.defaultExpectation.params = &ChatServiceMockStopServiceParams{ctx}
...
// ExpectCtxParam1 sets up expected param ctx for ChatService.StopService
func (mmStopService *mChatServiceMockStopService) ExpectCtxParam1(ctx context.Context) *mChatServiceMockStopService {
	if mmStopService.mock.funcStopService != nil {
		mmStopService.mock.t.Fatalf("ChatServiceMock.StopService mock is already set by Set")
	}
	...
	if mmStopService.defaultExpectation.params != nil {
		mmStopService.mock.t.Fatalf("ChatServiceMock.StopService mock is already set by Expect")
	}

	if mmStopService.defaultExpectation.paramPtrs == nil {
		mmStopService.defaultExpectation.paramPtrs = &ChatServiceMockStopServiceParamPtrs{}
	}
...
// Inspect accepts an inspector function that has same arguments as the ChatService.StopService
func (mmStopService *mChatServiceMockStopService) Inspect(f func(ctx context.Context)) *mChatServiceMockStopService {
	if mmStopService.mock.inspectFuncStopService != nil {
		mmStopService.mock.t.Fatalf("Inspect function is already set for ChatServiceMock.StopService")
	}
...
// Return sets up results that will be returned by ChatService.StopService
func (mmStopService *mChatServiceMockStopService) Return() *ChatServiceMock {
	if mmStopService.mock.funcStopService != nil {
		mmStopService.mock.t.Fatalf("ChatServiceMock.StopService mock is already set by Set")
	}

	if mmStopService.defaultExpectation == nil {
		mmStopService.defaultExpectation = &ChatServiceMockStopServiceExpectation{mock: mmStopService.mock}
	}
...
// Set uses given function f to mock the ChatService.StopService method
func (mmStopService *mChatServiceMockStopService) Set(f func(ctx context.Context)) *ChatServiceMock {
	if mmStopService.defaultExpectation != nil {
		mmStopService.mock.t.Fatalf("Default expectation is already set for the ChatService.StopService method")
	}

	if len(mmStopService.expectations) > 0 {
		mmStopService.mock.t.Fatalf("Some expectations are already set for the ChatService.StopService method")
	}
...
// When sets expectation for the ChatService.StopService which will trigger the result defined by the following
// Then helper
func (mmStopService *mChatServiceMockStopService) When(ctx context.Context) *ChatServiceMockStopServiceExpectation {
	if mmStopService.mock.funcStopService != nil {
		mmStopService.mock.t.Fatalf("ChatServiceMock.StopService mock is already set by Set")
	}

	expectation := &ChatServiceMockStopServiceExpectation{
		mock:               mmStopService.mock,
		params:             &ChatServiceMockStopServiceParams{ctx},
		expectationOrigins: ChatServiceMockStopServiceExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
	mmStopService.expectations = append(mmStopService.expectations, expectation)
	return expectation
}

// Then sets up ChatService.StopService return parameters for the expectation previously defined by the When method

func (e *ChatServiceMockStopServiceExpectation) Then() *ChatServiceMock {
	return e.mock
}

// Times sets number of times ChatService.StopService should be invoked
func (mmStopService *mChatServiceMockStopService) Times(n uint64) *mChatServiceMockStopService {
	if n == 0 {
		mmStopService.mock.t.Fatalf("Times of ChatServiceMock.StopService mock can not be zero")
	}
...
func (mmStopService *mChatServiceMockStopService) invocationsDone() bool {
...
// StopService implements mm_service.ChatService
func (mmStopService *ChatServiceMock) StopService(ctx context.Context) {
	...
	mm_params := ChatServiceMockStopServiceParams{ctx}
	...
	if mmStopService.StopServiceMock.defaultExpectation != nil {
		...
		mm_got := ChatServiceMockStopServiceParams{ctx}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmStopService.t.Errorf("ChatServiceMock.StopService got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			mmStopService.t.Errorf("ChatServiceMock.StopService got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	mmStopService.t.Fatalf("Unexpected call to ChatServiceMock.StopService. %v", ctx)

}

// StopServiceAfterCounter returns a count of finished ChatServiceMock.StopService invocations
func (mmStopService *ChatServiceMock) StopServiceAfterCounter() uint64 {
	return mm_atomic.LoadUint64(&mmStopService.afterStopServiceCounter)
}

// StopServiceBeforeCounter returns a count of ChatServiceMock.StopService invocations
func (mmStopService *ChatServiceMock) StopServiceBeforeCounter() uint64 {
	return mm_atomic.LoadUint64(&mmStopService.beforeStopServiceCounter)
}

// Calls returns a list of arguments used in each call to ChatServiceMock.StopService.
// The list is in the same order as the calls were made (i.e. recent calls have a higher index)
func (mmStopService *mChatServiceMockStopService) Calls() []*ChatServiceMockStopServiceParams {
	mmStopService.mutex.RLock()

	argCopy := make([]*ChatServiceMockStopServiceParams, len(mmStopService.callArgs))
...
// the number of defined expectations
func (m *ChatServiceMock) MinimockStopServiceDone() bool {
...
func (m *ChatServiceMock) MinimockStopServiceInspect() {
	for _, e := range m.StopServiceMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to ChatServiceMock.StopService at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.StopServiceMock.invocationsDone() && afterStopServiceCounter > 0 {
		m.t.Errorf("Expected %d calls to ChatServiceMock.StopService at\n%s but found %d calls",
